  ...
  return (
    <>
      <div className="px-6 md:w-[400px] md:rounded-lg md:bg-dark md:p-8 md:text-white">
        ...
        <div className="group flex items-center gap-4 py-8 ">
          ...
          <div className="z-10 basis-1/4 md:basis-0">
            ...
            >
              ...
              <defs data-v-f455cab0="" data-v-706ceafa="">
                <filter
                  data-v-f455cab0=""
                  data-v-706ceafa=""
                  id="filter0_f-766671"
